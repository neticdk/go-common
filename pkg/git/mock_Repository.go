...
func (_e *MockRepository_Expecter) Config() *MockRepository_Config_Call {
	return &MockRepository_Config_Call{Call: _e.mock.On("Config")}
}

func (_c *MockRepository_Config_Call) Run(run func()) *MockRepository_Config_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockRepository_Config_Call) Return(_a0 *config.Config, _a1 error) *MockRepository_Config_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
// MockRepository_SetUpstream_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetUpstream'
type MockRepository_SetUpstream_Call struct {
	*mock.Call
}
...
func (_c *MockRepository_SetUpstream_Call) Return(_a0 error) *MockRepository_SetUpstream_Call {
	_c.Call.Return(_a0)
	return _c
}
